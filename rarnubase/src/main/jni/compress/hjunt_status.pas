...
// export jni
function Java_com_rarnu_base_utils_ZipUtils_getCompressErrorCode(env: PJNIEnv; obj: jobject; filePath: jstring): jint; stdcall;
function Java_com_rarnu_base_utils_ZipUtils_getCompressErrorMessage(env: PJNIEnv; obj: jobject; filePath: jstring): jstring; stdcall;
function Java_com_rarnu_base_utils_ZipUtils_getCompressFileCount(env: PJNIEnv; obj: jobject; filePath: jstring): jint; stdcall;
function Java_com_rarnu_base_utils_ZipUtils_getCompressedCount(env: PJNIEnv; obj: jobject; filePath: jstring): jint; stdcall;
function Java_com_rarnu_base_utils_ZipUtils_getUncompressErrorCode(env: PJNIEnv; obj: jobject; filePath: jstring): jint; stdcall;
function Java_com_rarnu_base_utils_ZipUtils_getUncompressErrorMessage(env: PJNIEnv; obj: jobject; filePath: jstring): jstring; stdcall;
function Java_com_rarnu_base_utils_ZipUtils_getUncompressFileCount(env: PJNIEnv; obj: jobject; filePath: jstring): jint; stdcall;
function Java_com_rarnu_base_utils_ZipUtils_getUncompressedCount(env: PJNIEnv; obj: jobject; filePath: jstring): jint; stdcall;
...
function Java_com_rarnu_base_utils_ZipUtils_getCompressErrorCode(
  env: PJNIEnv; obj: jobject; filePath: jstring): jint; stdcall;
var
  item: TCompressStatus;
begin
  Result := 0;
  item := _GetCompressStatus(TJNIEnv.jstringToString(env, filePath));
  if (item <> nil) then begin
    Result := item.errorCode;
  end;
end;

function Java_com_rarnu_base_utils_ZipUtils_getCompressErrorMessage(
...
function Java_com_rarnu_base_utils_ZipUtils_getCompressFileCount(
  env: PJNIEnv; obj: jobject; filePath: jstring): jint; stdcall;
var
  item: TCompressStatus;
begin
...
function Java_com_rarnu_base_utils_ZipUtils_getCompressedCount(
  env: PJNIEnv; obj: jobject; filePath: jstring): jint; stdcall;
var
  item: TCompressStatus;
begin
...
function Java_com_rarnu_base_utils_ZipUtils_getUncompressErrorCode(
  env: PJNIEnv; obj: jobject; filePath: jstring): jint; stdcall;
var
  item: TUncompressStatus;
begin
  Result := 0;
  item := _GetUncompressStatus(TJNIEnv.jstringToString(env, filePath));
  if (item <> nil) then begin
    Result := item.errorCode;
  end;
end;

function Java_com_rarnu_base_utils_ZipUtils_getUncompressErrorMessage(
  env: PJNIEnv; obj: jobject; filePath: jstring): jstring; stdcall;
var
  item: TUncompressStatus;
  ret: string;
...
function Java_com_rarnu_base_utils_ZipUtils_getUncompressFileCount(
  env: PJNIEnv; obj: jobject; filePath: jstring): jint; stdcall;
var
  item: TUncompressStatus;
begin
...
function Java_com_rarnu_base_utils_ZipUtils_getUncompressedCount(
  env: PJNIEnv; obj: jobject; filePath: jstring): jint; stdcall;
var
  item: TUncompressStatus;
begin
