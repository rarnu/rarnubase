...
uses
  Classes, SysUtils, JNI2, hjlockbox, math;
...
function Java_com_rarnu_base_security_AlgorithmUtils_dsaGenerateKeys(env: PJNIEnv; obj: jobject; keySize: jint; pubPass: jstring; privPass: jstring; pubSavePath: jstring; privSavePath: jstring): jint; stdcall;
function Java_com_rarnu_base_security_AlgorithmUtils_dsaSignString(env: PJNIEnv; obj: jobject; keySize: jint; privPass: jstring; privPath: jstring; str: jstring): jstring; stdcall;
function Java_com_rarnu_base_security_AlgorithmUtils_dsaSignFile(env: PJNIEnv; obj: jobject; keySize: jint; privPass: jstring; privPath: jstring; filePath: jstring): jstring; stdcall;
function Java_com_rarnu_base_security_AlgorithmUtils_dsaVerifyString(env: PJNIEnv; obj: jobject; keySize: jint; pubPass: jstring; pubPath: jstring; rs: PChar; str: jstring): jint; stdcall;
function Java_com_rarnu_base_security_AlgorithmUtils_dsaVerifyFile(env: PJNIEnv; obj: jobject; keySize: jint; pubPass: jstring; pubPath: jstring; rs: PChar; filePath: jstring): jint; stdcall;
function Java_com_rarnu_base_security_AlgorithmUtils_dsaGetPubkeyQPGY(env: PJNIEnv; obj: jobject; keySize: jint; pubPass: jstring; pubPath: jstring): jstring; stdcall;
function Java_com_rarnu_base_security_AlgorithmUtils_dsaGetPrivkeyQPGX(env: PJNIEnv; obj: jobject; keySize: jint; privPass: jstring; privPath: jstring): jstring; stdcall;
...
function Java_com_rarnu_base_security_AlgorithmUtils_dsaGenerateKeys(
  env: PJNIEnv; obj: jobject; keySize: jint; pubPass: jstring;
  privPass: jstring; pubSavePath: jstring; privSavePath: jstring): jint;
  stdcall;
begin
  Result := _dsaGenerateKeys(keySize, PChar(TJNIEnv.JStringToString(env, pubPass)), PChar(TJNIEnv.jstringToString(env, privPass)), PChar(TJNIEnv.JStringToString(env, pubSavePath)), PChar(TJNIEnv.JStringToString(env, privSavePath)));
end;

function Java_com_rarnu_base_security_AlgorithmUtils_dsaSignString(
  env: PJNIEnv; obj: jobject; keySize: jint; privPass: jstring;
  privPath: jstring; str: jstring): jstring; stdcall;
var
  ret: PChar;
begin
  ret := _dsaSignString(keySize, PChar(TJNIEnv.JStringToString(env, privPass)), PChar(TJNIEnv.JStringToString(env, privPath)), PChar(TJNIEnv.JStringToString(env, str)));
  Result := TJNIEnv.StringToJString(env, string(ret));
end;

function Java_com_rarnu_base_security_AlgorithmUtils_dsaSignFile(
  env: PJNIEnv; obj: jobject; keySize: jint; privPass: jstring;
  privPath: jstring; filePath: jstring): jstring; stdcall;
var
  ret: PChar;
begin
  ret := _dsaSignFile(keySize, PChar(TJNIEnv.JStringToString(env, privPass)), PChar(TJNIEnv.jstringToString(env, privPath)), PChar(TJNIEnv.jstringToString(env, filePath)));
  Result := TJNIEnv.stringToJString(env, string(ret));
end;

function Java_com_rarnu_base_security_AlgorithmUtils_dsaVerifyString(
  env: PJNIEnv; obj: jobject; keySize: jint; pubPass: jstring;
  pubPath: jstring; rs: PChar; str: jstring): jint; stdcall;
begin
  Result := _dsaVerifyString(keySize, PChar(TJNIEnv.jstringToString(env, pubPass)), PChar(TJNIEnv.jstringToString(env, pubPath)), PChar(TJNIEnv.jstringToString(env, rs)), PChar(TJNIEnv.jstringToString(env, str)));
end;

function Java_com_rarnu_base_security_AlgorithmUtils_dsaVerifyFile(
  env: PJNIEnv; obj: jobject; keySize: jint; pubPass: jstring;
  pubPath: jstring; rs: PChar; filePath: jstring): jint; stdcall;
begin
  Result := _dsaVerifyFile(keySize, PChar(TJNIEnv.jstringToString(env, pubPass)), PChar(TJNIEnv.jstringToString(env, pubPath)), PChar(TJNIEnv.jstringToString(env, rs)), PChar(TJNIEnv.jstringToString(env, filePath)));
end;

function Java_com_rarnu_base_security_AlgorithmUtils_dsaGetPubkeyQPGY(
  env: PJNIEnv; obj: jobject; keySize: jint; pubPass: jstring; pubPath: jstring
  ): jstring; stdcall;
var
  ret: PChar;
begin
  ret := _dsaGetPubkeyQPGY(keySize, PChar(TJNIEnv.jstringToString(env, pubPass)), PChar(TJNIEnv.jstringToString(env, pubPath)));
  Result := TJNIEnv.stringToJString(env, string(ret));
end;

function Java_com_rarnu_base_security_AlgorithmUtils_dsaGetPrivkeyQPGX(
  env: PJNIEnv; obj: jobject; keySize: jint; privPass: jstring;
  privPath: jstring): jstring; stdcall;
var
  ret: PChar;
begin
  ret := _dsaGetPrivkeyQPGX(keySize, PChar(TJNIEnv.jstringToString(env, privPass)), PChar(TJNIEnv.jstringToString(env, privPath)));
  Result := TJNIEnv.stringToJString(env, string(ret));
end;
