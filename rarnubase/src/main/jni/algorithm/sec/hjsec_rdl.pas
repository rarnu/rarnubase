...
function Java_com_rarnu_base_security_AlgorithmUtils_rdlEncryptString(env: PJNIEnv; obj: jobject; keySize: jint; cipherMode: jint; key: jstring; str: jstring): jstring; stdcall;
function Java_com_rarnu_base_security_AlgorithmUtils_rdlEncryptFile(env: PJNIEnv; obj: jobject; keySize: jint; cipherMode: jint; key: jstring; filePath: jstring; outFilePath: jstring): jint; stdcall;
function Java_com_rarnu_base_security_AlgorithmUtils_rdlDecryptString(env: PJNIEnv; obj: jobject; keySize: jint; cipherMode: jint; key: jstring; str: jstring): jstring; stdcall;
function Java_com_rarnu_base_security_AlgorithmUtils_rdlDecryptFile(env: PJNIEnv; obj: jobject; keySize: jint; cipherMode: jint; key: jstring; filePath: jstring; outFilePath: jstring): jint; stdcall;
...
function Java_com_rarnu_base_security_AlgorithmUtils_rdlEncryptString(
  env: PJNIEnv; obj: jobject; keySize: jint; cipherMode: jint; key: jstring;
  str: jstring): jstring; stdcall;
var
  ret: PChar;
begin
  ret := _rdlEncryptString(keySize, 1, PChar(TJNIEnv.jstringToString(env, key)), PChar(TJNIEnv.jstringToString(env, str)));
  Result := TJNIEnv.stringToJString(env, string(ret));
end;

function Java_com_rarnu_base_security_AlgorithmUtils_rdlEncryptFile(
  env: PJNIEnv; obj: jobject; keySize: jint; cipherMode: jint; key: jstring;
  filePath: jstring; outFilePath: jstring): jint; stdcall;
begin
  Result := _rdlEncryptFile(keySize, 1, PChar(TJNIEnv.jstringToString(env, key)), PChar(TJNIEnv.jstringToString(env, filePath)), PChar(TJNIEnv.jstringToString(env, outFilePath)));
end;

function Java_com_rarnu_base_security_AlgorithmUtils_rdlDecryptString(
  env: PJNIEnv; obj: jobject; keySize: jint; cipherMode: jint; key: jstring;
  str: jstring): jstring; stdcall;
var
  ret: PChar;
begin
  ret := _rdlDecryptString(keySize, 1, PChar(TJNIEnv.jstringToString(env, key)), PChar(TJNIEnv.jstringToString(env, str)));
  Result := TJNIEnv.stringToJString(env, string(ret));
end;

function Java_com_rarnu_base_security_AlgorithmUtils_rdlDecryptFile(
  env: PJNIEnv; obj: jobject; keySize: jint; cipherMode: jint; key: jstring;
  filePath: jstring; outFilePath: jstring): jint; stdcall;
begin
  Result := _rdlDecryptFile(keySize, 1, PChar(TJNIEnv.jstringToString(env, key)), PChar(TJNIEnv.jstringToString(env, filePath)), PChar(TJNIEnv.jstringToString(env, outFilePath)));
end;
