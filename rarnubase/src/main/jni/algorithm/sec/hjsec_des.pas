...
function Java_com_rarnu_base_security_AlgorithmUtils_desEncryptString(env: PJNIEnv; obj: jobject; str: jstring; key: jstring): jstring; stdcall;
function Java_com_rarnu_base_security_AlgorithmUtils_desDecryptString(env: PJNIEnv; obj: jobject; str: jstring; key: jstring): jstring; stdcall;
...
function Java_com_rarnu_base_security_AlgorithmUtils_desEncryptString(
  env: PJNIEnv; obj: jobject; str: jstring; key: jstring): jstring; stdcall;
var
  ret: PChar;
begin
  ret  := _desEncryptString(PChar(TJNIEnv.JStringToString(env, str)), PChar(TJNIEnv.JStringToString(env, key)));
  Result := TJNIEnv.StringToJString(env, string(ret));
end;

function Java_com_rarnu_base_security_AlgorithmUtils_desDecryptString(
  env: PJNIEnv; obj: jobject; str: jstring; key: jstring): jstring; stdcall;
var
  ret: PChar;
begin
  ret := _desDecryptString(PChar(TJNIEnv.JStringToString(env, str)), PChar(TJNIEnv.JStringToString(env, key)));
  Result := TJNIEnv.StringToJString(env, string(ret));
end;
