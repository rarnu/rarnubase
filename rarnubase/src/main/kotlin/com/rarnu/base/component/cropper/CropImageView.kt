package com.rarnu.base.component.cropper
...
class CropImageView: ImageView {
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        ...
        _borderPaint = PaintUtil.newBorderPaint(context)
        _guidelinePaint = PaintUtil.newGuidelinePaint(context)
        _surroundingAreaOverlayPaint = PaintUtil.newSurroundingAreaOverlayPaint(context)
        _cornerPaint = PaintUtil.newCornerPaint(context)
